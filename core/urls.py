...
urlpatterns = [
    ...
    path("owner/qnc/get/", getQuestionsAndCompetitions, name="get-questions-competitions"),
    path("owner/qnc/get/details/", getQuestionsAndCompetitionsDetails, name="get-questions-competitions-details"),
    path("owner/qnc/get/submissions/", getQuestionsAndCompetitionsSubmissions, name="get-questions-competitions-submissions"),
    path("owner/qnc/update/", updateQuestionsAndCompetitions, name="update-questions-competitions-submissions"),
    path("owner/qnc/delete/", deleteQuestionAndCompetition, name="delete-questions-competitions"),
    path("owner/qnc/delete/submissions/", deleteQuestionAndCompetitionSubmissions, name="delete-questions-competitions-submissions"),
    path("owner/add/updates/", addUpdates, name="add-updates"),
    ...
    path("user/profile/home/", profileHomePage, name="profile-home-page"),
    path("user/profile/info/", getInfo, name="profile-get-info"),
    path("user/profile/info/change/", updateInfo, name="profile-update-info"),
    path("user/profile/info/change/verify/", updateInfoVerify, name="profile-update-info-verify"),
]
